...
class Dragon(AI_player):
    ...
    def __init__(self, name, Game, team, weapon):
        ...
        self.weapon = weapon
        self.naturalweapon = Weapon_list.fangs
        self.wonpic = 'https://pa1.narvii.com/6920/75e1c7baefd30745c105b5f55924e908b09369f3r1-480-270_hq.gif'
        self.dodgecd = 0
        self.ability_ready = True
        self.dodge_ready = True
        if self.weapon == Weapon_list.drago:
            ...
            self.maxenergy += 1
            self.energy += 1
        elif self.weapon == Weapon_list.drago:
            self.abilities = [special_abilities.Piromant, special_abilities.Armorer]
            self.accuracy += 1
            self.dropweapons.append(Weapon_list.iceman)
            self.accuracy += 1
...
class Sup(AI_player):
    ...
    def __init__(self, name, Game, team, weapon):
        ...
        self.weapon = weapon
        self.naturalweapon = Weapon_list.fangs
        self.wonpic = 'BQADAgADdAIAAmV5mUjw41iEtGCWPwI'
        self.dodgecd = 0
        self.ability_ready = True
        self.dodge_ready = True
...
thanosm = Weapon_list.Thanos(1, 1, 2, 10, 1, True, False, False, 'Cheksizlik','1-3' + u'\U0001F525' + "|" + '2' + u'\U000026A1', 3, standart=False,natural=True)
